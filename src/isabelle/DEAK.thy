...
"ruleRuleSwapout x RuleSwapout.Swapout_L = ( case x of (RelAKA rel) \<Rightarrow>((ActS\<^sub>S (forwA\<^sub>S) (?\<^sub>Act ''alpha'') (AgS\<^sub>S (forwK\<^sub>S) (?\<^sub>Ag ''a'') (?\<^sub>S ''X''))) \<turnstile>\<^sub>S (?\<^sub>S ''Ylist'')) \<Longrightarrow>RD swapout_L rel | _ \<Rightarrow> ((?\<^sub>S''X'') \<turnstile>\<^sub>S (?\<^sub>S''Y'')) \<Longrightarrow>RD (\<lambda>x. None) )" |
"ruleRuleSwapout x RuleSwapout.Swapout_R = ( case x of (RelAKA rel) \<Rightarrow>((?\<^sub>S ''Ylist'') \<turnstile>\<^sub>S (ActS\<^sub>S (forwA\<^sub>S) (?\<^sub>Act ''alpha'') (AgS\<^sub>S (forwK\<^sub>S) (?\<^sub>Ag ''a'') (?\<^sub>S ''X'')))) \<Longrightarrow>RD swapout_R rel | _ \<Rightarrow> ((?\<^sub>S''X'') \<turnstile>\<^sub>S (?\<^sub>S''Y'')) \<Longrightarrow>RD (\<lambda>x. None) )"
